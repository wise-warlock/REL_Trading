...
class StockTradingEnv(gym.Env):
    ...
    def step(self, action):
        ...
        agent_return = (equity / self.prev_total_asset) if self.prev_total_asset > 0 else 0
...
model.save("ppo_recurrent_stock_trader_v15")
...
model = RecurrentPPO.load("ppo_recurrent_stock_trader_v15")
